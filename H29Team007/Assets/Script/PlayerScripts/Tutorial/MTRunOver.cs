...
public class MTRunOver : MonoBehaviour {
    ...
    private bool CanGetEnemy(Transform cart)
    {
        ...
        {
            MTSecurity sg = gameObject.GetComponent<MTSecurity>();
    ...
    public void OnTriggerEnter(Collider other)
    {
        ...
        {
            if (other.transform.root.GetComponent<MTPlayer>().GetFowardSpeed() <= 0.1f * 0.1f) return;
            if (transform.tag == "Bull")
            {
